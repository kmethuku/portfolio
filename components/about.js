...
const About = () => {
  return (
    <div className="about" id="about">
      <div className="kiran-container"><img src="kiran.jpg"/></div>
      <div className="about-text">
        ...
        chip cookies, guaranteed 🍪) and reading. Some of my favorite books include Ender's
        Game and The Graveyard Book.
        </div>
      </div>
    </div>
  )
